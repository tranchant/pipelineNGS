...
{
	my ($dirOut)=@_; 	#shift;
	my (%stat); 		#Hash retournŽ par la fonction
...
Ce module regroupe un ensemble de fonctions liŽes au logiciel fastqc http://www.bioinformatics.babraham.ac.uk/projects/fastqc/
